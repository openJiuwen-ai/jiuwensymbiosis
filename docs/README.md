...
- [使用远程 HTTP 视觉与语音服务](zh/how-to/remote-inference.md)
- [接入一个 GUI 插件](zh/how-to/add-gui.md)
...
- [Use Remote HTTP Vision and Speech](en/how-to/remote-inference.md)
- [Add a GUI Plugin](en/how-to/add-gui.md)
