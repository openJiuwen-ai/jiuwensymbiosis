...
def test_picks_the_target_on_the_reference(monkeypatch):
    ...
    r = api._scene._detect_related("white box", "brown table", "on", None, None, None, None)
    assert r["ok"] is True
...
def test_picks_the_surface_holding_the_reference(monkeypatch):
    ...
    r = api._scene._sense_surface_related("table", "water cup", "under", None, None, None, None)
    assert r["ok"] is True
...
def test_beside_picks_the_neighbour_not_the_stack(monkeypatch):
    ...
    r = api._scene._detect_related("box", "hat", "beside", None, None, None, None)
    assert r["ok"] is True
